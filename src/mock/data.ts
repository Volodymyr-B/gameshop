export const data = [
  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/ru/3/33/Overwatch_Origins_Edition_PC_cover.jpg",
    description:
...

  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/ru/2/26/AC_Valhalla_standard_edition.jpg",
    description:
...

  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/ru/5/5e/%D0%9E%D0%B1%D0%BB%D0%BE%D0%B6%D0%BA%D0%B0_The_Sims_4.jpeg",
    description:
...

  {
    ...
    platform: { pc: false, playstation: true, xbox: true },
    image:
      "https://delistedgames.com/wp-content/uploads/2020/04/cookingmamacookstar.jpg",
    description:
...

  {
    ...
    platform: { pc: true, playstation: true, xbox: true },
    image:
      "https://upload.wikimedia.org/wikipedia/ru/thumb/4/4e/Doom3box.jpg/274px-Doom3box.jpg",
    description:
...

  {
    ...
    platform: { pc: true, playstation: false, xbox: false },
    image:
      "https://torrents-igruha.org/uploads/posts/2021-01/1611444215_25.jpg",
    description:
...

  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/ru/0/0e/Life_Is_Strange_Before_The_Storm.jpg",
    description:
...

  {
    ...
    platform: { pc: false, playstation: true, xbox: true },
    image:
      "https://upload.wikimedia.org/wikipedia/ru/3/3a/The_Elder_Scrolls_V_-_Skyrim.jpg",
    description:
...

  {
    ...
    platform: { pc: true, playstation: true, xbox: true },
    image:
      "https://cdn-products.eneba.com/resized-products/q7LfT94FS4Fc5KomlwjjI_pJxUyWdneCLgsWqqRRuAQ_350x200_1x-0.jpeg",
    description:
...

  {
    ...
    platform: { pc: true, playstation: false, xbox: false },
    image:
      "https://s1.gaming-cdn.com/images/products/8970/271x377/f1-2021-xbox-one-xbox-series-xs-cover.jpg",
    description:
  ...
  },
  {
    ...
    platform: { pc: true, playstation: true, xbox: true },
    image:
      "https://upload.wikimedia.org/wikipedia/ru/thumb/4/4b/Hitman_3_Packart.jpg/1200px-Hitman_3_Packart.jpg",
    description:
...

  {
    ...
    platform: { pc: true, playstation: true, xbox: true },
    image:
      "https://store-images.s-microsoft.com/image/apps.36981.69312789698701726.d27b8773-a696-422a-8e4e-47d9f8fde34f.c3287c35-a0e9-411d-ba6a-459b891e4106",
    description:
